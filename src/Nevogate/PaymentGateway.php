 ...
 * PHP SDK
 *
 * @link https://github.com/pmgw-hu/payment-gateway-php7-sdk.git
...
use Nevogate\PaymentGateway\Request\RedirectLocationInterface;
use Nevogate\PaymentGateway\Request\RequestInterface;
use Nevogate\PaymentGateway\Transport\Response\Response;
use Nevogate\PaymentGateway\Transport\Response\ResponseInterface;
...
class PaymentGateway
{
	...
	const PROVIDER_RAWKHBSZEP = 'RawKHBSZEP';
