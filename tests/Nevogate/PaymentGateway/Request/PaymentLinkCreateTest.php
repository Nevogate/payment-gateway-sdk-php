...
use Nevogate\PaymentGateway\Request\PaymentLinkCreate;
...
class PaymentLinkCreateTest extends \PHPUnit\Framework\TestCase
{
	...
	public function dataProviderFor_parameterTest()
	{
		return array(
			...
			array('http://test.hu/general-terms-and-conditions', 'setGeneralTermsAndConditionsUrl'),
	 ...
	 * @expectedException \Nevogate\PaymentGateway\Exception\PaymentGatewayException
	 */
	public function setGeneralTermsAndConditionsUrl_invalidUrl()
	{
		$request = $this->getRequest();
		$request->setGeneralTermsAndConditionsUrl('invalidUrl');
	}
